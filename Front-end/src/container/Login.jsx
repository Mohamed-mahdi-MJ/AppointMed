            ...
            {splash ? (
                ...
                >
                    <section className="flex flex-row items-center">
                        <LazyLoadImage src="/logo.png" alt="logo" effect="blur" className="lg:w-[13rem] lg:h-[13rem] sm:w-[10rem] sm:h-[10rem] ssm:w-[8rem] ssm:h-[8rem]" />
                        <h1 className="lg:text-5xl sm:text-4xl ssm:text-3xl font-semibold tracking--wide">Appointmed</h1>
                    </section>
                </motion.div>
            ) : (
                <Suspense fallback={<></>}>
